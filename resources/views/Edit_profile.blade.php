...
@section('content')
        ...
        <main class="edit-profile">
            <section class="profile-form">
                ...
                <form action="{{route('profile.update',$user->username)}}" method="post" class="edit-profile__form"
                    ...
                    <div class="edit-profile__form-row">
                        ...
                        <input type="text" id="username" name="username" class="edit-profile__input"
                               value="{{$user->username}}">
                        @error('username')
                        <span class=" pl-2 text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                    ...
                    <div class="edit-profile__form-row">
                        ...
                        <input type="url" name="link" placeholder="eg. https://www.google.com" id="website"
