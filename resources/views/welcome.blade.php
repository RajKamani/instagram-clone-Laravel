...
<body class="antialiased no-padding">
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ route('home') }}" class="text-sm text-gray-700 underline">Goto Dashboard</a>
            @endauth
        </div>
    @endif
    <main class="login">
            ...
            <div class="login__section login__sign-in">
                ...
                <form method="POST" action="{{ route('login') }}" class="login__form">
                    ...
                    <div class="login__input-container">
                        ...
                        />
                        @error('email')
                        <span class="text-danger invalid-feedback" style="color: red">
                    ...
                    <div class="login__input-container">
                        ...
                        @if (Route::has('password.request'))
                            <a class="btn btn-link login__form-link" href="{{ route('password.request') }}">
                                {{ __('Forgot?') }}
                            </a>
                        @endif
                    </div>
                    @error('password')
                    <span><p class="text-danger" style="color: red">{{ $message }}</p></span>
                    @enderror
                    <div class="login__input-container">
                        <input
                            type="submit"
